...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-video-conference-video-conference-module"], {
  ...
  /***/
  function srcAppModulesVideoConferenceVideoConferenceRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "VideoConferenceRoutingModule", function () {
      return VideoConferenceRoutingModule;
    });
    /* harmony import */
    ...
    var _video_conference_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./video-conference.component */
    "./src/app/modules/video-conference/video-conference.component.ts");

    var routes = [{
      path: '',
      component: _video_conference_component__WEBPACK_IMPORTED_MODULE_2__["VideoConferenceComponent"]
    }];

    var VideoConferenceRoutingModule = function VideoConferenceRoutingModule() {
      _classCallCheck(this, VideoConferenceRoutingModule);
    };

    VideoConferenceRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: VideoConferenceRoutingModule
    });
    VideoConferenceRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function VideoConferenceRoutingModule_Factory(t) {
        return new (t || VideoConferenceRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](VideoConferenceRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](VideoConferenceRoutingModule, [{
  ...
  /***/
  function srcAppModulesVideoConferenceVideoConferenceComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_services_consultation_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var VideoConferenceComponent =
    /*#__PURE__*/
    function () {
      function VideoConferenceComponent(document, confernceService, messageService, router, userService, CookieService) {
      ...
      _createClass(VideoConferenceComponent, [{
        ...
        value: function getSession() {
          ...
          if (this.userService.getUserDesignation() === 'Doctor') {
            this.confernceService.getDoctorSession().then(function (resData) {
              if (resData.code === 200) {
                _this.sessionId = resData.data.sessionId;
                _this.token = resData.data.token;

                _this.initializeSession();
              } else {
                _this.showToast('error', "Session Faild", resData.data);
            ...
            this.confernceService.getPatientSession().then(function (resData) {
              if (resData.code === 200) {
                _this.sessionId = resData.data.sessionId;
                _this.token = resData.data.token;
        ...
        key: "getSessionChecked",
        value: function getSessionChecked() {
          var _this2 = this;

          var timeInterval = setInterval(function () {
            if (_this2.userService.getUserDesignation() === 'Doctor') {
              _this2.confernceService.getDoctorSession().then(function (resData) {
                if (resData.code === 201) {
            ...
            } else if (_this2.userService.getUserDesignation() === 'User') {
              _this2.confernceService.getPatientSession().then(function (resData) {
                if (resData.code === 201) {
                  clearInterval(timeInterval);
        ...
        value: function endSession() {
          ...
          var Cooki = JSON.parse(this.CookieService.get('userInfo_WhealthyLife'));
          var data = {
            patient: Cooki._id
          };
          this.confernceService.endSession(data).then(function (resData) {
            console.log("VideoConferenceComponent -> endSession -> resData", resData);
            _this3.document.location.href = 'http://localhost:4200/';
          })["catch"](function (error) {
    ...
    VideoConferenceComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 24,
      vars: 3,
      consts: [[1, "custom-error", 3, "showTransformOptions"], ["id", "videos"], ["id", "subscriber"], ["id", "publisher"], ["id", "endcall"], ["mat-flat-button", "", "color", "warn", 3, "click"], ["id", "timer"], ["id", "addPrescription"], ["mat-raised-button", ""], ["id", "addMedicine"], ["id", "addMedia"]],
      template: function VideoConferenceComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function VideoConferenceComponent_Template_button_click_5_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](VideoConferenceComponent, [{
        ...
        return [{
          ...
          type: src_app_services_consultation_service__WEBPACK_IMPORTED_MODULE_2__["ConsultationService"]
        }, {
  ...
  /***/
  function srcAppModulesVideoConferenceVideoConferenceModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "VideoConferenceModule", function () {
      return VideoConferenceModule;
    });
    /* harmony import */
    ...
    var _video_conference_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./video-conference-routing.module */
    "./src/app/modules/video-conference/video-conference-routing.module.ts");
    /* harmony import */


    var _video_conference_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./video-conference.component */
    "./src/app/modules/video-conference/video-conference.component.ts");
    /* harmony import */
    ...
    var VideoConferenceModule = function VideoConferenceModule() {
      _classCallCheck(this, VideoConferenceModule);
    };

    VideoConferenceModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: VideoConferenceModule
    });
    VideoConferenceModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function VideoConferenceModule_Factory(t) {
        return new (t || VideoConferenceModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _video_conference_routing_module__WEBPACK_IMPORTED_MODULE_2__["VideoConferenceRoutingModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](VideoConferenceModule, {
        declarations: [_video_conference_component__WEBPACK_IMPORTED_MODULE_3__["VideoConferenceComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _video_conference_routing_module__WEBPACK_IMPORTED_MODULE_2__["VideoConferenceRoutingModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](VideoConferenceModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          declarations: [_video_conference_component__WEBPACK_IMPORTED_MODULE_3__["VideoConferenceComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _video_conference_routing_module__WEBPACK_IMPORTED_MODULE_2__["VideoConferenceRoutingModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]]
...
//# sourceMappingURL=modules-video-conference-video-conference-module-es5.js.map