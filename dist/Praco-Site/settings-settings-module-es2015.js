...
/* harmony import */ var _settings_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./settings.component */ "./src/app/modules/doctor-dashbord/settings/settings.component.ts");
...
const routes = [
    {
        path: '', component: _settings_component__WEBPACK_IMPORTED_MODULE_0__["SettingsComponent"], children: [
            { path: 'practice-details', loadChildren: () => __webpack_require__.e(/*! import() | practice-details-practice-details-module */ "practice-details-practice-details-module").then(__webpack_require__.bind(null, /*! ./practice-details/practice-details.module */ "./src/app/modules/doctor-dashbord/settings/practice-details/practice-details.module.ts")).then(dd => dd.PracticeDetailsModule) },
            { path: 'PracticeStaff', loadChildren: () => __webpack_require__.e(/*! import() | practice-staff-practice-staff-module */ "practice-staff-practice-staff-module").then(__webpack_require__.bind(null, /*! ./practice-staff/practice-staff.module */ "./src/app/modules/doctor-dashbord/settings/practice-staff/practice-staff.module.ts")).then(dd => dd.PracticeStaffModule) },
            { path: 'Calendar', loadChildren: () => __webpack_require__.e(/*! import() | calendar-calendar-module */ "calendar-calendar-module").then(__webpack_require__.bind(null, /*! ./calendar/calendar.module */ "./src/app/modules/doctor-dashbord/settings/calendar/calendar.module.ts")).then(dd => dd.CalendarModule) },
            { path: 'Communications', loadChildren: () => __webpack_require__.e(/*! import() | communications-communications-module */ "communications-communications-module").then(__webpack_require__.bind(null, /*! ./communications/communications.module */ "./src/app/modules/doctor-dashbord/settings/communications/communications.module.ts")).then(dd => dd.CommunicationsModule) },
            { path: 'PricingCatalog', loadChildren: () => __webpack_require__.e(/*! import() | pricing-catalog-pricing-catalog-module */ "pricing-catalog-pricing-catalog-module").then(__webpack_require__.bind(null, /*! ./pricing-catalog/pricing-catalog.module */ "./src/app/modules/doctor-dashbord/settings/pricing-catalog/pricing-catalog.module.ts")).then(dd => dd.PricingCatalogModule) },
            { path: 'ConsentForms', loadChildren: () => __webpack_require__.e(/*! import() | consent-forms-consent-forms-module */ "consent-forms-consent-forms-module").then(__webpack_require__.bind(null, /*! ./consent-forms/consent-forms.module */ "./src/app/modules/doctor-dashbord/settings/consent-forms/consent-forms.module.ts")).then(dd => dd.ConsentFormsModule) },
            { path: 'DataSecurity', loadChildren: () => __webpack_require__.e(/*! import() | data-security-data-security-module */ "data-security-data-security-module").then(__webpack_require__.bind(null, /*! ./data-security/data-security.module */ "./src/app/modules/doctor-dashbord/settings/data-security/data-security.module.ts")).then(dd => dd.DataSecurityModule) },
            { path: 'ClinicalNotesCatalog', loadChildren: () => __webpack_require__.e(/*! import() | clinical-notes-catalog-clinical-notes-catalog-module */ "clinical-notes-catalog-clinical-notes-catalog-module").then(__webpack_require__.bind(null, /*! ./clinical-notes-catalog/clinical-notes-catalog.module */ "./src/app/modules/doctor-dashbord/settings/clinical-notes-catalog/clinical-notes-catalog.module.ts")).then(dd => dd.ClinicalNotesCatalogModule) },
            { path: 'DrugCatalog', loadChildren: () => __webpack_require__.e(/*! import() | drug-catalog-drug-catalog-module */ "drug-catalog-drug-catalog-module").then(__webpack_require__.bind(null, /*! ./drug-catalog/drug-catalog.module */ "./src/app/modules/doctor-dashbord/settings/drug-catalog/drug-catalog.module.ts")).then(dd => dd.DrugCatalogModule) },
            { path: 'ChartingTemplates', loadChildren: () => __webpack_require__.e(/*! import() | charting-templates-charting-templates-module */ "charting-templates-charting-templates-module").then(__webpack_require__.bind(null, /*! ./charting-templates/charting-templates.module */ "./src/app/modules/doctor-dashbord/settings/charting-templates/charting-templates.module.ts")).then(dd => dd.ChartingTemplatesModule) },
            { path: 'Printouts', loadChildren: () => __webpack_require__.e(/*! import() | printouts-printouts-module */ "printouts-printouts-module").then(__webpack_require__.bind(null, /*! ./printouts/printouts.module */ "./src/app/modules/doctor-dashbord/settings/printouts/printouts.module.ts")).then(dd => dd.PrintoutsModule) },
            { path: 'Emails', loadChildren: () => __webpack_require__.e(/*! import() | emails-emails-module */ "emails-emails-module").then(__webpack_require__.bind(null, /*! ./emails/emails.module */ "./src/app/modules/doctor-dashbord/settings/emails/emails.module.ts")).then(dd => dd.EmailsModule) },
            { path: 'Billing', loadChildren: () => __webpack_require__.e(/*! import() | billing-billing-module */ "billing-billing-module").then(__webpack_require__.bind(null, /*! ./billing/billing.module */ "./src/app/modules/doctor-dashbord/settings/billing/billing.module.ts")).then(dd => dd.BillingModule) },
            { path: 'PatientGroups', loadChildren: () => __webpack_require__.e(/*! import() | patient-groups-patient-groups-module */ "patient-groups-patient-groups-module").then(__webpack_require__.bind(null, /*! ./patient-groups/patient-groups.module */ "./src/app/modules/doctor-dashbord/settings/patient-groups/patient-groups.module.ts")).then(dd => dd.PatientGroupsModule) },
            { path: 'ImportExport', loadChildren: () => __webpack_require__.e(/*! import() | import-export-import-export-module */ "import-export-import-export-module").then(__webpack_require__.bind(null, /*! ./import-export/import-export.module */ "./src/app/modules/doctor-dashbord/settings/import-export/import-export.module.ts")).then(dd => dd.ImportExportModule) },
            { path: 'AutomaticIDGeneration', loadChildren: () => __webpack_require__.e(/*! import() | automatic-idgeneration-automatic-idgeneration-module */ "automatic-idgeneration-automatic-idgeneration-module").then(__webpack_require__.bind(null, /*! ./automatic-idgeneration/automatic-idgeneration.module */ "./src/app/modules/doctor-dashbord/settings/automatic-idgeneration/automatic-idgeneration.module.ts")).then(dd => dd.AutomaticIDGenerationModule) },
            { path: 'Insurance', loadChildren: () => __webpack_require__.e(/*! import() | insurance-insurance-module */ "insurance-insurance-module").then(__webpack_require__.bind(null, /*! ./insurance/insurance.module */ "./src/app/modules/doctor-dashbord/settings/insurance/insurance.module.ts")).then(dd => dd.InsuranceModule) },
        ]
    }
];
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SettingsSidebarComponent, [{
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _settings_sidebar_settings_sidebar_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./settings-sidebar/settings-sidebar.component */ "./src/app/modules/doctor-dashbord/settings/settings-sidebar/settings-sidebar.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
SettingsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SettingsComponent, selectors: [["app-settings"]], decls: 6, vars: 0, consts: [[1, "row"], [1, "col-md-2"], [1, "col-md-10"]], template: function SettingsComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _settings_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./settings-routing.module */ "./src/app/modules/doctor-dashbord/settings/settings-routing.module.ts");
/* harmony import */ var _settings_sidebar_settings_sidebar_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./settings-sidebar/settings-sidebar.component */ "./src/app/modules/doctor-dashbord/settings/settings-sidebar/settings-sidebar.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](SettingsModule, { declarations: [_settings_component__WEBPACK_IMPORTED_MODULE_0__["SettingsComponent"],
        _settings_sidebar_settings_sidebar_component__WEBPACK_IMPORTED_MODULE_4__["SettingsSidebarComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
        _settings_routing_module__WEBPACK_IMPORTED_MODULE_3__["SettingsRoutingModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](SettingsModule, [{
        ...
        args: [{
                declarations: [_settings_component__WEBPACK_IMPORTED_MODULE_0__["SettingsComponent"],
                    _settings_sidebar_settings_sidebar_component__WEBPACK_IMPORTED_MODULE_4__["SettingsSidebarComponent"],
                ],
                imports: [
                    _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                    _settings_routing_module__WEBPACK_IMPORTED_MODULE_3__["SettingsRoutingModule"]
