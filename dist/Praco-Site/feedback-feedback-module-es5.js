...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["feedback-feedback-module"], {
  ...
  /***/
  function srcAppModulesDoctorDashbordFeedbackFeedbackRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _feedback_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./feedback.component */
    ...
    var routes = [{
      path: '',
      component: _feedback_component__WEBPACK_IMPORTED_MODULE_0__["FeedbackComponent"]
    }];
    ...
    FeedbackRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: FeedbackRoutingModule
    });
    FeedbackRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](FeedbackRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](FeedbackRoutingModule, [{
  ...
  /***/
  function srcAppModulesDoctorDashbordFeedbackFeedbackComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    FeedbackComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 19,
      vars: 1,
      consts: [[1, "card", "card-main"], [1, "header"], [1, "head-text"], [1, "card-body"], [1, "row"], [1, "col-sm-4"], [1, "flex"], [1, "mat-text-lable"], [1, "mat-sl"], [3, "value", "valueChange"], ["value", "option1"], ["value", "option2"], ["value", "option3"]],
      template: function FeedbackComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function FeedbackComponent_Template_mat_select_valueChange_12_listener($event) {
      ...
      directives: [_angular_material_form_field__WEBPACK_IMPORTED_MODULE_1__["MatFormField"], _angular_material_select__WEBPACK_IMPORTED_MODULE_2__["MatSelect"], _angular_material_core__WEBPACK_IMPORTED_MODULE_3__["MatOption"]],
  ...
  /***/
  function srcAppModulesDoctorDashbordFeedbackFeedbackModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    FeedbackModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: FeedbackModule
    });
    FeedbackModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function FeedbackModule_Factory(t) {
        return new (t || FeedbackModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _feedback_routing_module__WEBPACK_IMPORTED_MODULE_3__["FeedbackRoutingModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](FeedbackModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](FeedbackModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"],
        args: [{
          declarations: [_feedback_component__WEBPACK_IMPORTED_MODULE_0__["FeedbackComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _feedback_routing_module__WEBPACK_IMPORTED_MODULE_3__["FeedbackRoutingModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]]
