...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["automatic-idgeneration-automatic-idgeneration-module"], {
  ...
  /***/
  function srcAppModulesDoctorDashbordSettingsAutomaticIdgenerationAutomaticIdgenerationRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AutomaticIDGenerationRoutingModule", function () {
      return AutomaticIDGenerationRoutingModule;
    });
    /* harmony import */


    var _automatic_idgeneration_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./automatic-idgeneration.component */
    ...
    var routes = [{
      path: '',
      component: _automatic_idgeneration_component__WEBPACK_IMPORTED_MODULE_0__["AutomaticIDGenerationComponent"]
    }];

    var AutomaticIDGenerationRoutingModule = function AutomaticIDGenerationRoutingModule() {
      _classCallCheck(this, AutomaticIDGenerationRoutingModule);
    };

    AutomaticIDGenerationRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: AutomaticIDGenerationRoutingModule
    });
    AutomaticIDGenerationRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function AutomaticIDGenerationRoutingModule_Factory(t) {
        return new (t || AutomaticIDGenerationRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AutomaticIDGenerationRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AutomaticIDGenerationRoutingModule, [{
  ...
  /***/
  function srcAppModulesDoctorDashbordSettingsAutomaticIdgenerationAutomaticIdgenerationComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AutomaticIDGenerationComponent", function () {
      return AutomaticIDGenerationComponent;
    });
    /* harmony import */


    var _receipt_id_gen_receipt_id_gen_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./receipt-id-gen/receipt-id-gen.component */
    "./src/app/modules/doctor-dashbord/settings/automatic-idgeneration/receipt-id-gen/receipt-id-gen.component.ts");
    /* harmony import */


    var _invoice_id_gen_invoice_id_gen_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./invoice-id-gen/invoice-id-gen.component */
    "./src/app/modules/doctor-dashbord/settings/automatic-idgeneration/invoice-id-gen/invoice-id-gen.component.ts");
    /* harmony import */


    var _patient_id_gen_patient_id_gen_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./patient-id-gen/patient-id-gen.component */
    ...
    function AutomaticIDGenerationComponent_div_54_Template(rf, ctx) {
      if (rf & 1) {
        var _r905 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵgetCurrentView"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AutomaticIDGenerationComponent_div_54_Template_button_click_20_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r905);

          var ctx_r904 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]();

          return ctx_r904.InvoiceID();
        });
    ...
    function AutomaticIDGenerationComponent_div_55_Template(rf, ctx) {
      if (rf & 1) {
        var _r907 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵgetCurrentView"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AutomaticIDGenerationComponent_div_55_Template_button_click_20_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r907);

          var ctx_r906 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]();

          return ctx_r906.ReceiptID();
        });
    ...
    var AutomaticIDGenerationComponent =
    /*#__PURE__*/
    function () {
      function AutomaticIDGenerationComponent(dialog) {
        _classCallCheck(this, AutomaticIDGenerationComponent);
      ...
      _createClass(AutomaticIDGenerationComponent, [{
        key: "ngOnInit",
        ...
        key: "ReceiptID",
        value: function ReceiptID() {
          this.showReceipt = !this.showReceipt;
        }
      }, {
        key: "modalopen",
        value: function modalopen() {
          var dialogRef = this.dialog.open(_patient_id_gen_patient_id_gen_component__WEBPACK_IMPORTED_MODULE_2__["PatientIdGenComponent"]);
        ...
        value: function InvoiceModalOpen() {
          var dialogRef = this.dialog.open(_invoice_id_gen_invoice_id_gen_component__WEBPACK_IMPORTED_MODULE_1__["InvoiceIdGenComponent"]);
          dialogRef.afterClosed().subscribe(function (result) {
            console.log("Dialog result: ".concat(result));
          });
        }
      }, {
        key: "RecieptModalOpen",
        value: function RecieptModalOpen() {
          var dialogRef = this.dialog.open(_receipt_id_gen_receipt_id_gen_component__WEBPACK_IMPORTED_MODULE_0__["ReceiptIdGenComponent"]);
          dialogRef.afterClosed().subscribe(function (result) {
            console.log("Dialog result: ".concat(result));
          });
        }
    ...
    AutomaticIDGenerationComponent.ɵfac = function AutomaticIDGenerationComponent_Factory(t) {
      return new (t || AutomaticIDGenerationComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"]));
    };

    AutomaticIDGenerationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      type: AutomaticIDGenerationComponent,
      selectors: [["app-automatic-idgeneration"]],
      decls: 56,
      vars: 3,
      consts: [[1, "container-fluid"], [1, "card"], [1, "card-header"], [1, "card-body"], [1, "row"], [1, "section-heading-main"], [1, "ui-checkbox"], [1, "example-margin"], [1, "desc-text"], [1, "body-normal-grey"], [3, "click"], [1, "row", "mt-4"], [1, "section-heading"], ["class", "modal  ", "id", "myModal", 4, "ngIf"], ["class", "modal", "id", "myModal", 4, "ngIf"], ["id", "myModal", 1, "modal"], [1, "modal-xl", "dialog", "modal-dialog-centered"], [1, "modal-content"], [1, "modal-header"], ["id", "exampleModalLongTitle", 1, "modal-title"], [1, "modal-body"], [1, "container"], [1, "col-sm-6"], [1, "form-group"], ["type", "email", "value", "P", "id", "exampleInputEmail1", "aria-describedby", "emailHelp", 1, "form-control"], ["type", "email", "value", "1", "id", "exampleInputEmail1", "aria-describedby", "emailHelp", 1, "form-control"], [1, "col-sm-12"], [1, "labl"], [1, "form-check"], ["type", "checkbox", "id", "exampleCheck1", 1, "form-check-input"], ["for", "exampleCheck1", 1, "form-check-label", "frmchk"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-light", "btnmodal", 3, "click"], ["type", "button", 1, "btn", "btn-warning", "btnmodal"], ["type", "email", "value", "INV", "id", "exampleInputEmail1", "aria-describedby", "emailHelp", 1, "form-control"], ["type", "email", "value", "RCPT", "id", "exampleInputEmail1", "aria-describedby", "emailHelp", 1, "form-control"]],
      template: function AutomaticIDGenerationComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AutomaticIDGenerationComponent_Template_a_click_19_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AutomaticIDGenerationComponent_Template_a_click_35_listener() {
            return ctx.InvoiceModalOpen();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AutomaticIDGenerationComponent_Template_a_click_51_listener() {
            return ctx.RecieptModalOpen();
          });
  ...
  /***/
  function srcAppModulesDoctorDashbordSettingsAutomaticIdgenerationAutomaticIdgenerationModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AutomaticIDGenerationModule", function () {
      return AutomaticIDGenerationModule;
    });
    /* harmony import */
    ...
    var _automatic_idgeneration_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./automatic-idgeneration.component */
    "./src/app/modules/doctor-dashbord/settings/automatic-idgeneration/automatic-idgeneration.component.ts");
    /* harmony import */
    ...
    var _automatic_idgeneration_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./automatic-idgeneration-routing.module */
    "./src/app/modules/doctor-dashbord/settings/automatic-idgeneration/automatic-idgeneration-routing.module.ts");
    /* harmony import */


    var _patient_id_gen_patient_id_gen_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./patient-id-gen/patient-id-gen.component */
    "./src/app/modules/doctor-dashbord/settings/automatic-idgeneration/patient-id-gen/patient-id-gen.component.ts");
    /* harmony import */


    var _invoice_id_gen_invoice_id_gen_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./invoice-id-gen/invoice-id-gen.component */
    "./src/app/modules/doctor-dashbord/settings/automatic-idgeneration/invoice-id-gen/invoice-id-gen.component.ts");
    /* harmony import */


    var _receipt_id_gen_receipt_id_gen_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./receipt-id-gen/receipt-id-gen.component */
    "./src/app/modules/doctor-dashbord/settings/automatic-idgeneration/receipt-id-gen/receipt-id-gen.component.ts");

    var AutomaticIDGenerationModule = function AutomaticIDGenerationModule() {
      _classCallCheck(this, AutomaticIDGenerationModule);
    };

    AutomaticIDGenerationModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
      type: AutomaticIDGenerationModule
    });
    AutomaticIDGenerationModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
      factory: function AutomaticIDGenerationModule_Factory(t) {
        return new (t || AutomaticIDGenerationModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _automatic_idgeneration_routing_module__WEBPACK_IMPORTED_MODULE_4__["AutomaticIDGenerationRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_0__["SharedModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](AutomaticIDGenerationModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](AutomaticIDGenerationModule, [{
  ...
  /***/
  function srcAppModulesDoctorDashbordSettingsAutomaticIdgenerationInvoiceIdGenInvoiceIdGenComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "InvoiceIdGenComponent", function () {
      return InvoiceIdGenComponent;
    });
    /* harmony import */
    ...
    var InvoiceIdGenComponent =
    /*#__PURE__*/
    function () {
      function InvoiceIdGenComponent() {
        _classCallCheck(this, InvoiceIdGenComponent);
      }

      _createClass(InvoiceIdGenComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    InvoiceIdGenComponent.ɵfac = function InvoiceIdGenComponent_Factory(t) {
      return new (t || InvoiceIdGenComponent)();
    };

    InvoiceIdGenComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: InvoiceIdGenComponent,
      selectors: [["app-invoice-id-gen"]],
      decls: 22,
      vars: 1,
      consts: [["mat-dialog-title", ""], [1, "mat-typography", "mt-4", "mat-dialog-container"], [1, "col-md-12", "col-sm-12"], [1, "row"], [1, "col-sm-6"], [1, "form-group"], [1, "l-b-p"], ["type", "email", "value", "INV", "id", "exampleInputEmail1", "aria-describedby", "emailHelp", 1, "form-control"], [1, "sp"], ["type", "email", "value", "1", "id", "exampleInputEmail1", "aria-describedby", "emailHelp", 1, "form-control"], ["align", "end"], ["mat-button", "", "mat-dialog-close", ""], ["mat-button", "", "cdkFocusInitial", "", 1, "mat-button-t", 3, "mat-dialog-close"]],
      template: function InvoiceIdGenComponent_Template(rf, ctx) {
        if (rf & 1) {
  ...
  /***/
  function srcAppModulesDoctorDashbordSettingsAutomaticIdgenerationPatientIdGenPatientIdGenComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PatientIdGenComponent", function () {
      return PatientIdGenComponent;
    });
    /* harmony import */
    ...
    var PatientIdGenComponent =
    /*#__PURE__*/
    function () {
      function PatientIdGenComponent() {
        _classCallCheck(this, PatientIdGenComponent);
      }

      _createClass(PatientIdGenComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    PatientIdGenComponent.ɵfac = function PatientIdGenComponent_Factory(t) {
      return new (t || PatientIdGenComponent)();
    };

    PatientIdGenComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: PatientIdGenComponent,
      selectors: [["app-patient-id-gen"]],
      decls: 30,
      vars: 1,
      consts: [[1, "container-fludic"], ["mat-dialog-title", ""], [1, "mat-typography", "mt-4"], [1, "col-md-12", "col-sm-12"], [1, "row"], [1, "col-sm-6"], [1, "form-group"], [1, "l-b-p"], ["type", "email", "value", "P", "id", "exampleInputEmail1", "aria-describedby", "emailHelp", 1, "form-control"], [1, "sp"], ["type", "email", "value", "1", "id", "exampleInputEmail1", "aria-describedby", "emailHelp", 1, "form-control"], [1, "col-sm-12"], [1, "labl"], [1, "form-check"], ["align", "end"], ["mat-button", "", "mat-dialog-close", ""], ["mat-button", "", "cdkFocusInitial", "", 1, "mat-button-t", 3, "mat-dialog-close"]],
      template: function PatientIdGenComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PatientIdGenComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesDoctorDashbordSettingsAutomaticIdgenerationReceiptIdGenReceiptIdGenComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ReceiptIdGenComponent", function () {
      return ReceiptIdGenComponent;
    });
    /* harmony import */
    ...
    var ReceiptIdGenComponent =
    /*#__PURE__*/
    function () {
      function ReceiptIdGenComponent() {
        _classCallCheck(this, ReceiptIdGenComponent);
      }

      _createClass(ReceiptIdGenComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    ReceiptIdGenComponent.ɵfac = function ReceiptIdGenComponent_Factory(t) {
      return new (t || ReceiptIdGenComponent)();
    };

    ReceiptIdGenComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ReceiptIdGenComponent,
      selectors: [["app-receipt-id-gen"]],
      decls: 22,
      vars: 1,
      consts: [["mat-dialog-title", ""], [1, "mat-typography", "mt-4"], [1, "col-md-12", "col-sm-12"], [1, "row"], [1, "col-sm-6"], [1, "form-group"], [1, "l-b-p"], ["type", "email", "value", "RCPT", "id", "exampleInputEmail1", "aria-describedby", "emailHelp", 1, "form-control"], [1, "sp"], ["type", "email", "value", "1", "id", "exampleInputEmail1", "aria-describedby", "emailHelp", 1, "form-control"], ["align", "end"], ["mat-button", "", "mat-dialog-close", ""], ["mat-button", "", "cdkFocusInitial", "", 1, "mat-button-t", 3, "mat-dialog-close"]],
      template: function ReceiptIdGenComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ReceiptIdGenComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
//# sourceMappingURL=automatic-idgeneration-automatic-idgeneration-module-es5.js.map