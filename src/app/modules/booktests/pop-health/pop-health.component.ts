...
export class PopHealthComponent implements OnInit {
  ...
  ngOnInit() {
    this.Router.params.subscribe((params) => {
      ...
      console.log("🚀 ~ file: pop-health.component.ts ~ line 61 ~ PopHealthComponent ~ this.Router.params.subscribe ~ this.LabId", this.LabId);
  ...
  getTESTApi(){
    this.MainService.getTestById(this.LabId).then((TestresData)=>{
    console.log("🚀 ~ file: pop-health.component.ts ~ line 79 ~ PopHealthComponent ~ this.MainService.getTestById ~ TestresData", TestresData)
