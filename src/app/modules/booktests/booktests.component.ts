...
export class BooktestsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.reg = this.formBuilder.group({
      ...
      console.log("🚀 ~ file: booktests.component.ts ~ line 235 ~ BooktestsComponent ~ this.reg.valueChanges.subscribe ~ resData", resData)
        
      })


    // this.filteredOptions = this.reg.valueChanges
    //   .pipe(
    //     startWith(''),
  ...
  _filter(value: string): string[] {
    console.log("🚀 ~ file: booktests.component.ts ~ line 241 ~ BooktestsComponent ~ _filter ~ value", value)
